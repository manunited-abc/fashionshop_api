...
import nlu.fashionshopapi.payload.request.LoginRequest;
import nlu.fashionshopapi.payload.request.SignupRequest;
import nlu.fashionshopapi.payload.response.JwtResponse;
import nlu.fashionshopapi.payload.response.MessageResponse;
import nlu.fashionshopapi.repository.RoleRepository;
import nlu.fashionshopapi.repository.UserRepository;
import nlu.fashionshopapi.security.JwtUtils;
import nlu.fashionshopapi.service.impl.UserDetailsImpl;
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    if (userRepository.existsByEmail(signUpRequest.getEmail())) {
      return ResponseEntity
          .badRequest()
          .body(new MessageResponse("Email not exist"));
    }
